...
public class TextEncodedStringSizeTerminated extends AbstractString {
    ...
    public void readByteArray(byte[] arr, int offset) throws InvalidDataTypeException {
        ...
        if (java.nio.charset.StandardCharsets.UTF_16.equals(getTextEncodingCharSet())) {
    ...
    protected ByteBuffer writeStringUTF16LEBOM(final String next, final int i, final int noOfValues)
            throws CharacterCodingException {
        final CharsetEncoder encoder = java.nio.charset.StandardCharsets.UTF_16LE.newEncoder();
    ...
    protected ByteBuffer writeStringUTF16BEBOM(final String next, final int i, final int noOfValues)
            throws CharacterCodingException {
        final CharsetEncoder encoder = java.nio.charset.StandardCharsets.UTF_16BE.newEncoder();
        encoder.onMalformedInput(CodingErrorAction.IGNORE);
        encoder.onUnmappableCharacter(CodingErrorAction.IGNORE);
    ...
    public byte[] writeByteArray() {
        ...
        try {
            ...
            if (java.nio.charset.StandardCharsets.UTF_16.equals(charset)) {
                if (TagOptionSingleton.getInstance().isEncodeUTF16BomAsLittleEndian()) {
                    actualCharSet = java.nio.charset.StandardCharsets.UTF_16LE;
                } else {
                    actualCharSet = java.nio.charset.StandardCharsets.UTF_16BE;
                }
            }
            ...
            for (int i = 0; i < values.size(); i++) {
                ...
                if (java.nio.charset.StandardCharsets.UTF_16LE.equals(actualCharSet)) {
